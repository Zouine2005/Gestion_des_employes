        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-departement" class="collapse submenu" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            ...
                            <li class="submenu-item"><a class="submenu-link" href="{{route('departement.create')}}">Ajoute</a></li>
                        </ul>
                    </div>
                </li><!--//nav-item-->
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-employes" class="collapse submenu" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="{{route('employer.index')}}">Liste</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="{{route('employer.create')}}">Ajoute</a></li>
                        </ul>
                    </div>
                </li><!--//nav-item-->				    
