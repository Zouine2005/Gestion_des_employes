...
<head>
    ...
    <style>
        ...
        * {
        ...
        body {
            background: linear-gradient(90deg, #008D9A, rgb(195,211,54));        
        }
        ...
        .screen {        
            background: linear-gradient(90deg, #008D9A, rgb(158, 171, 45));        
            position: relative;    
            height: 600px;
            width: 360px;    
        ...
        .screen_background_shape3 {
            height: 540px;
            width: 190px;
            background: linear-gradient(270deg, rgb(195,211,54), #008D9A);
            top: -24px;
            right: 0;    
            border-radius: 32px;
        }
    ...
    <div class="container">
        <div class="screen">
            <div class="screen__content">
                <form class="login" method="POST" action="{{route('handlelogin')}}">
                    @csrf
                    @method('POST')
