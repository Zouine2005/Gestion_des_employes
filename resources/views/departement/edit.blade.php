...
<div class="row g-4 settings-section">
    <div class="col-12 col-md-4">
        <h3 class="section-title">Modifier departement</h3>
            ...
            <div class="app-card-body">
                <form class="settings-form" method="POST" action="{{ route('departement.update',$departement->id) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-1" placeholder="Entrez le nom du département" name="name" value="{{$departement->name}}" required><br>
                        @if ($errors->any())
